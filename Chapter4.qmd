...
Performing this test on the CPU performance data and splitting the data so group 1 includes fitted values \<50 and group 2 has fitted values $\ge 50$ yields:
